const REDIRECT_ALLOWLIST = new Set<string>([
  ...
  "/school_it_events",
  "/school_it_reports",
  "/school_it_attendance",
  "/school_it_announcements",
  "/school_it_create_department_program",
  "/school_it_branding",
  "/school_it_import_users",
  "/school_it_password_resets",
  "/school_it_manage_users",
  "/school_it_audit_logs",
  "/school_it_notifications",
  "/school_it_security",
  "/school_it_face_verification",
  "/school_it_subscription",
  "/school_it_governance",
  "/school_it_governance_hierarchy",
  "/school_it_profile",
  "/ssg_dashboard",
  "/ssg_home",
  "/ssg_profile",
