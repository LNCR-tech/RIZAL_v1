...
import SemesterProgressBar from '@/components/shared/dashboard/SemesterProgressBar.vue'
import AttendanceStatusHero from '@/components/shared/dashboard/AttendanceStatusHero.vue'
import QuickStatsRow from '@/components/shared/dashboard/QuickStatsRow.vue'
import SsgSgBreakdown from '@/components/shared/dashboard/SsgSgBreakdown.vue'
import UpcomingEventsSection from '@/components/shared/dashboard/UpcomingEventsSection.vue'
import AttendanceHistoryTable from '@/components/shared/dashboard/AttendanceHistoryTable.vue'
